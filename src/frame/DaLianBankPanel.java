...
public class DaLianBankPanel extends JPanel {
	...
	private JLabel cardNoLabel,nameLabel,beginAmountLabel,currentTimeLabel,incomeLabel,salaryLabel,salaryDateLabel,consumeLabel;
	private JTextField cardNoField,nameField,currentTimeField,incomeField,salaryField,salaryDateField,consumeField,beginAmountField;
	private JButton processBtn;
	
	public DaLianBankPanel(){
		...
		processBtn.addActionListener(new ActionListener(){
			...
			public void actionPerformed(ActionEvent e) {
				if (e.getSource() == processBtn){
					...
					DaLianBankHandler handler = new DaLianBankHandler();
					...
					DaLianBankExcel excel = new DaLianBankExcel();
					 Date startTime = new Date();//当前时间
				     SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd");    
				     String startStr = sdf.format(startTime);
				     String[] dateStr = startStr.split("-");
					 excel.writeToExcel("d:\\大连银行"+userName+".xls", details,cardNo,userName,"60730",dateStr[0]+"年"+dateStr[1]+"月"+dateStr[2]+"日");
